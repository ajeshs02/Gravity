...
const StoreOrderCard = ({ order }) => {
  ...
  return (
    ...
    >
      ...
      {/* middle */}
      <div className="flex ml-3  lg:text-base  font-medium  justify-around h-full items-start mr-auto  flex-col w-4/6 text-sm  p-3">
      ...
      {/* right */}
      {/* <div
        className={`w-1/6  flex rounded-lg justify-center items-center gap-y-3`}
      >
        <button className="items-center justify-center rounded-md bg-white border border-red-500  px-5 mx-3 py-2.5 text-center text-sm  text-red-500   font-bold hover:text-white hover:bg-red-600 whitespace-pre-wrap transition-all active:scale-95 ">
          cancel order
        </button>
      </div> */}
    </article>
